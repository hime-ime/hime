...
enum {
    ...
    HIME_CHINESE_ENGLISH_TOGGLE_KEY_Shift = 2,
    HIME_CHINESE_ENGLISH_TOGGLE_KEY_ShiftL = 4,
    HIME_CHINESE_ENGLISH_TOGGLE_KEY_ShiftR = 8,
};
...
extern gboolean key_press_shift;
