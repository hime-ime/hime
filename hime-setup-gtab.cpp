...
#define SPC 1
  ...
  GtkWidget *label_hime_capslock_lower = gtk_label_new(_(_L("\t用小寫字母")));
  gtk_box_pack_start (GTK_BOX (hbox_hime_capslock_lower), label_hime_capslock_lower,  FALSE, FALSE, 0);
