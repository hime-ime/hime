...
[ ! -e debian/hime/usr/lib/gtk-3.0/immodules/im-hime.so  ] && sed -i 's/, hime-gtk3-immodule//' debian/hime/DEBIAN/control
...
if [ -d debian/hime/usr/lib/gtk-2.0/immodules ]; then
